...
时间: 2022/5/23
更新时间: 2022/8/16
牌组: GRE单词`}]})]),e[4]||(e[4]=o('<p>需要说明，在以上的例子中，「GRE单词」同时是牌堆名与牌组名。在 <code>.draw keys GRE单词</code> 中，它作为牌堆名出现；在 <code>.draw desc GRE单词</code> 中，它作为牌组名出现。</p><p><code>.draw keys</code> 列出所有可抽取的牌组列表。</p><div class="warning custom-block"><p class="custom-block-title">注意：谨慎使用</p><p>这一指令会将<strong>所有</strong>可抽取的牌组列出，在牌组较多时造成刷屏。</p></div><h3 id="抽牌" tabindex="-1">抽牌 <a class="header-anchor" href="#抽牌" aria-label="Permalink to &quot;抽牌&quot;">​</a></h3><p><code>.draw &lt;牌组名称&gt; (&lt;数量&gt;#)</code> 在指定牌组抽指定数量的牌，默认为抽 1 张。</p>',5)),t("div",u,[e[1]||(e[1]=t("p",{class:"custom-block-title"},"示例",-1)),n(a,{messages:[{content:".draw GRE单词 3#",send:!0},{content:`<木落>抽出了：
GRE3178
invoice n.

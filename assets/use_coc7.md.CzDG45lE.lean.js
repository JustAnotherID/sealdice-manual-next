...
<Szz>的个人属性为:
生命值:9/10`}]})]),C,t("div",A,[D,V,o(a,{messages:[{content:".ra 侦查",send:!0},{content:'<木落>的"侦查"检定结果为: D100=64/40 失败'},{content:".ra 侦查+10",send:!0},{content:'<木落>的"侦查"检定结果为: D100=15/50 困难成功'},{content:".ra 侦查99",send:!0},{content:'<木落>的"侦查"检定结果为: D100=30/99 困难成功'}]})]),I,N,B,t("div",E,[R,o(a,{messages:[{content:".ra 3# 侦查",send:!0},{content:`对<木落>的"侦查"进行了3次检定，结果为:
D100=87/40 失败
D100=24/40 成功
D100=1/40 大成功`}]})]),y,K,L,t("div",w,[$,H,o(a,{messages:[{content:".ra 困难侦查+10",send:!0},{content:'<木落>的"困难侦查+10"检定结果为: D100=30/25 失败'}]})]),O,j,J,t("div",U,[F,o(a,{messages:[{content:".ra b2 侦查",send:!0},{content:'<木落>的"侦查"检定结果为: b2=1/40, ([D100=51, 奖励 0 2]) 大成功!'}]})]),G,M,t("div",Q,[W,X,o(a,{messages:[{content:".ra 侦查 @Szz",send:!0},{content:`由<木落>代骰:
<Szz>的"侦查"检定结果为: D100=65/80 成功`}]})]),Y,t("div",Z,[tt,o(a,{messages:[{content:".ra 3# p 困难侦查+10 @Szz",send:!0},{content:`由<木落>代骰:
对<Szz>的"困难侦查+10"进行了3次检定，结果为:
p=36/45, ([D100=16, 惩罚 3]) 成功
p=91/45, ([D100=91, 惩罚 8]) 失败
p=75/45, ([D100=5, 惩罚 7]) 失败`}]})]),et,t("div",ot,[at,o(i,null,{default:n(()=>[o(l,{label:"跑团群"},{default:n(()=>[o(a,{messages:[{username:"PL",avatar:"user1",content:"我要对这个 NPC 使用心理学"},{username:"KP",avatar:"user3",content:"可以",send:!0},{username:"KP",avatar:"user3",content:".rah 心理学 @PL",send:!0},{content:`由<KP>代骰:
<PL>悄悄进行了一项心理学检定`}]})]),_:1}),o(l,{label:"KP 收到的私聊信息"},{default:n(()=>[o(a,{messages:[{content:`来自群<跑团群>(群号)的暗中检定:
<PL>的"心理学"检定结果为：D100=70/70 成功`}]})]),_:1})]),_:1})]),ct,t("div",st,[nt,o(a,{messages:[{content:".rav 侦查+10 @Szz",send:!0},{content:`对抗检定:
木落 侦查+10-> 属性值:35 判定值:3 极难成功
Szz 侦查+10-> 属性值:90 判定值:23 困难成功
木落胜出！`}]})]),lt,dt,it,t("div",rt,[ht,o(a,{messages:[{content:".rav 潜行,b 侦查 @Szz",send:!0},{content:`对抗检定:
木落 潜行-> 属性值:20 判定值:7[[D100=97, 奖励 0]] 困难成功
Szz 侦查-> 属性值:80 判定值:28 困难成功
平手！请自行根据场景(如属性比较、攻击对反击，攻击对闪避)做出判断`}]})]),_t,t("div",pt,[ut,o(a,{messages:[{content:".sc 1/1D4+1",send:!0},{content:`<木落>的理智检定:
d100=9/60 极难成功
理智变化: 60 ➯ 59 (扣除1=1点)`}]})]),bt,t("div",mt,[kt,o(a,{messages:[{content:".sc 0/1 @Szz",send:!0},{content:`由<木落>代骰：
<Szz>的理智检定:
d100=82/60 失败！
理智变化: 60 ➯ 59 (扣除1=1点)`}]})]),gt,t("div",Pt,[ft,o(a,{messages:[{content:".coc 2",send:!0},{content:`<木落>的七版COC人物作成:
力量:65 敏捷:80 意志:55
体质:50 外貌:45 教育:90
体型:70 智力:75
HP:12 幸运:45 [530/575]
...
体质:60 外貌:75 教育:60
体型:50 智力:75
HP:11 幸运:55 [485/540]`}]})]),qt])}const It=r(p,[["render",Tt]]);export{Vt as __pageData,It as default};
